...
Visualization & Business Insights — developed intuitive visual dashboards using Power BI and Python.

tools & Libraries Used:

Python Packages: Pandas, NumPy, Scikit-learn, Matplotlib, Seaborn, mlxtend

Visualization: Power BI for dashboards and trend reports
...
Business insight interpretation and strategy formulation
